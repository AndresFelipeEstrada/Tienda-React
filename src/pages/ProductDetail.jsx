  ...
  return (
    <aside className='ProductDetail'>
      <section className='text-gray-700 body-font overflow-hidden bg-white'>
        <div key={productDetail.id} className='container px-5 py-24 mx-auto'>
            ...
            <div className='lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0'>
              ...
              <div className='flex mb-4'>
                <span className='flex items-center'>
                  ...
                  <svg fill='none' className='w-4 h-4 text-red-500' viewBox='0 0 24 24'>
                    <path d='M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z' />
                  </svg>
              ...
              <div className='flex'>
                ...
                <button className='flex ml-auto text-hospital-green bg-white-300 border border-hospital-green hover:bg-hospital-green hover:text-white py-2 px-6 focus:outline-none rounded'>Add To Cart</button>
