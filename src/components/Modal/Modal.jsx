const Modal = ({ onClose, productDetail }) => {
  const imagen = '../../../django-api/'
  return (
    <>
      <section className='flex items-center rounded-lg overflow-y-hidden antialiased overflow-x-hidden  bg-white border border-black shadow-lg inset-y-0 inset-x-0 fixed w-10/12 h-4/5 m-auto'>
              ...
              <form className='mt-5'>
                <div className='-mx-2 md:items-center md:flex'>
                  <div className='flex-1 px-2'>
                    ...
                    <input type='text' placeholder='John Doe...' className='block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:border-gray-700 focus:border-blue-400  focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40' />
                  </div>

                  <div className='flex-1 px-2 mt-4 md:mt-0'>
                    <label className='block mb-2 text-sm text-gray-600 '>Correo Electronico</label>
                    <input type='text' placeholder='correo@example.com...' className='block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:border-gray-700 focus:border-blue-400  focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40' />
                  </div>
                </div>
            ...
            <div className='mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10'>
              ...
              <div className='mt-2 space-y-8'>
                ...
                <p className='flex items-start -mx-2'>
                  ...
                  <span className='mx-2 text-gray-700 truncate w-72 dark:text-gray-400'>{productDetail.telefono}</span>
                </p>
                ...
                <p className='flex items-start -mx-2'>
                  ...
                  <span className='mx-2 text-gray-700 truncate w-72 dark:text-gray-400'>{productDetail.correo}</span>
                </p>
              </div>

              <div className='mt-6 w-80 md:mt-8'>
                <h3 className='text-headline'>Sigueme en mi redes</h3>
